...
void AnoteFrame::OnFunctionPaste(wxCommandEvent & WXUNUSED(event)) {
    if (wxTheClipboard->Open()) {
        if (wxTheClipboard->IsSupported(wxDF_TEXT) || wxTheClipboard->IsSupported(wxDF_UNICODETEXT) ||
            wxTheClipboard->IsSupported(wxDF_HTML)) {
...
void AnoteFrame::_create_controls() {
    ...
    m_staticText7 =
            new wxStaticText(m_ctrl_panel_function, wxID_ANY, _("Function definition:"), wxDefaultPosition,
                             wxDefaultSize, 0);
    ...
    m_ctrl_function_desc =
            new wxTextCtrl(sbSizer2->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
                           wxTE_MULTILINE);
    ...
    m_ctrl_panel_mcu = new wxPanel(m_ctrl_notebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
    wxBoxSizer *bSizer7;
    ...
    m_staticText9 = new wxStaticText(m_ctrl_panel_mcu, wxID_ANY, _("Number of pins:"), wxDefaultPosition, wxDefaultSize,
                                     0);
    m_staticText9->Wrap(-1);
    fgSizer5->Add(m_staticText9, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_ctrl_number_pins = new wxSpinCtrl(m_ctrl_panel_mcu, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
                                        wxSP_ARROW_KEYS, 2, 100, 8);
    fgSizer5->Add(m_ctrl_number_pins, 0, wxALL | wxEXPAND, 5);


    bSizer7->Add(fgSizer5, 0, wxEXPAND, 5);

    wxString m_ctrl_form_factorChoices[] = {_("Left/Right"), _("Square")};
    int m_ctrl_form_factorNChoices = sizeof(m_ctrl_form_factorChoices) / sizeof(wxString);
    m_ctrl_form_factor = new wxRadioBox(m_ctrl_panel_mcu, wxID_ANY, _("Form factor"), wxDefaultPosition, wxDefaultSize,
                                        m_ctrl_form_factorNChoices, m_ctrl_form_factorChoices, 1, wxRA_SPECIFY_COLS);
    m_ctrl_form_factor->SetSelection(0);
    bSizer7->Add(m_ctrl_form_factor, 0, wxALL | wxEXPAND, 5);


    m_ctrl_panel_mcu->SetSizer(bSizer7);
    m_ctrl_panel_mcu->Layout();
    bSizer7->Fit(m_ctrl_panel_mcu);
    m_ctrl_notebook->AddPage(m_ctrl_panel_mcu, _("MCU"), false);
