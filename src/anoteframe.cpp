...
AnoteFrame::AnoteFrame(const wxString &title) : wxFrame(NULL, wxID_ANY, title) {
...
void AnoteFrame::_connect_events() {
  Bind(wxEVT_MENU, &AnoteFrame::OnQuit, this, ID_QUIT);
  Bind(wxEVT_MENU, &AnoteFrame::OnAbout, this, ID_ABOUT);
}
